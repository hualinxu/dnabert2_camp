...
class BertModel(BertPreTrainedModel):
    ...
    Inputs:
        ...
        `output_all_encoded_layers`: boolean which controls the content of the `encoded_layers` orginal_data as described below. Default: `True`.
    ...
    Outputs: Tuple of (encoded_layers, pooled_output)
        ...
        `pooled_output`: a torch.FloatTensor of size [batch_size, hidden_size] which is the orginal_data of a
...
class BertLMPredictionHead(nn.Module):
    ...
    def __init__(self, config, bert_model_embedding_weights):
        ...
        # The orginal_data weights are the same as the input embeddings, but there is
        # an orginal_data-only bias for each token.
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    This head is just a linear layer on top of the pooled orginal_data. Used for,
    e.g., GLUE tasks.
    """
